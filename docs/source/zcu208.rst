...
* **Tria HDL Coder for ZCU208 examples ZIP file** (see instructions below
...
.. warning:: For **Matlab R2023 and older releases**.
  ...
  you must install older compatible versions. Double check the
  notes in MathWorks Add-On manager for RFSoC Explorer Matlab
  compatiblity.

From within MATLAB, once again open the Add-on explorer.
And search for 'RFSoC Explorer', then install it:

.. image:: ./images_zcu208/rfexplorer2.png

.. note::
  While completing the RFSoC Explorer setup for the ZCU208, make note of the
...
* `Click to open instructions for setting up RFSoC Explorer <https://rfsoc-mmw.readthedocs.io>`_
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Completing the steps to install and use RFSoC Explorer will ensure the
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Step  4 - Obtain the HDL Coder for ZCU208 SD card with examples zip file
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. warning::
...
* `Click to download the HDL Coder for ZCU208 zip file
...
RFSoC Explorer SD card that you setup prior.  Sandisk or Delkin SD cards
